...
.DESCRIPTION
   ...
   Alias: Invoke-KBUpdateCategory
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: updateCategory
   PS Module Safe Name: Invoke-KBUpdateCategory
   Function parsed from: CategoryProcedure.php
   Description parsed from: category_procedures.rst
#>
function Set-KBCategory {
