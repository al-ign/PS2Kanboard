...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveTaskFile
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeTaskFile
   PS Module Safe Name: Invoke-KBRemoveTaskFile
   Function parsed from: TaskFileProcedure.php
   Description parsed from: task_file_procedures.rst
#>
function Remove-KBTaskFile {
...
} # End Remove-KBTaskFile function
