<#
.Synopsis
   Download file contents (encoded in base64)
...
.DESCRIPTION
   ...
   Alias: Invoke-KBDownloadTaskFile, Get-KBTaskFileDownload
.OUTPUTS
   Returns base64 encoded string on success
   Returns empty string on failure
.NOTES
   API Function Name: downloadTaskFile
   PS Module Safe Name: Invoke-KBDownloadTaskFile
   Function parsed from: TaskFileProcedure.php
   Description parsed from: task_file_procedures.rst
#>
function Invoke-KBdownloadTaskFile {
...
} # End Invoke-KBdownloadTaskFile function
