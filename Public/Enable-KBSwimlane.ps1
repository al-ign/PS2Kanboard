...
.DESCRIPTION
   ...
   Alias: Invoke-KBEnableSwimlane
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: enableSwimlane
   PS Module Safe Name: Invoke-KBEnableSwimlane
   Function parsed from: SwimlaneProcedure.php
   Description parsed from: swimlane_procedures.rst
#>
function Enable-KBSwimlane {
...
} # End Enable-KBSwimlane function
