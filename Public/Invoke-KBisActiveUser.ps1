...
.DESCRIPTION
   ...
   Alias: Invoke-KBIsActiveUser
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: isActiveUser
   PS Module Safe Name: Invoke-KBIsActiveUser
   Function parsed from: UserProcedure.php
   Description parsed from: user_procedures.rst
#>
function Invoke-KBisActiveUser {
...
} # End Invoke-KBisActiveUser function
