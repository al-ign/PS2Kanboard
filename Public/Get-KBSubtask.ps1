...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetSubtask
.OUTPUTS
   Returns subtask properties on success
   Returns null on failure
.NOTES
   API Function Name: getSubtask
   PS Module Safe Name: Invoke-KBGetSubtask
   Function parsed from: SubtaskProcedure.php
   Description parsed from: subtask_procedures.rst
#>
function Get-KBSubtask {
