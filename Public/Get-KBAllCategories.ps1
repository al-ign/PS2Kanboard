...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllCategories
.OUTPUTS
   Returns List of categories on success
   Returns false on failure
.NOTES
   API Function Name: getAllCategories
   PS Module Safe Name: Invoke-KBGetAllCategories
   Function parsed from: CategoryProcedure.php
   Description parsed from: category_procedures.rst
#>
function Get-KBAllCategories {
...
} # End Get-KBAllCategories function
