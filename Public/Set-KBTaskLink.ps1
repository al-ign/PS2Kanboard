...
.DESCRIPTION
   ...
   Alias: Invoke-KBUpdateTaskLink
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: updateTaskLink
   PS Module Safe Name: Invoke-KBUpdateTaskLink
   Function parsed from: TaskLinkProcedure.php
   Description parsed from: internal_task_link_procedures.rst
#>
function Set-KBTaskLink {
...
Begin {
$ApiParameters = @('task_link_id', 'task_id', 'opposite_task_id', 'link_id')
$hashApiParameters = @{}
...
$jsonParameters = @('task_link_id', 'task_id', 'opposite_task_id', 'link_id')
$hashjsonParameters = @{}
