...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetUserByName
.OUTPUTS
   Returns user properties on success
   Returns null on failure
.NOTES
   API Function Name: getUserByName
   PS Module Safe Name: Invoke-KBGetUserByName
   Function parsed from: UserProcedure.php
   Description parsed from: user_procedures.rst
#>
function Get-KBUserByName {
