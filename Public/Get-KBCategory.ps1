...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetCategory
.OUTPUTS
   Returns category properties on success
   Returns null on failure
.NOTES
   API Function Name: getCategory
   PS Module Safe Name: Invoke-KBGetCategory
   Function parsed from: CategoryProcedure.php
   Description parsed from: category_procedures.rst
#>
function Get-KBCategory {
