...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllComments
.OUTPUTS
   Returns List of comments on success
   Returns false on failure
.NOTES
   API Function Name: getAllComments
   PS Module Safe Name: Invoke-KBGetAllComments
   Function parsed from: CommentProcedure.php
   Description parsed from: comment_procedures.rst
#>
function Get-KBAllComments {
...
} # End Get-KBAllComments function
