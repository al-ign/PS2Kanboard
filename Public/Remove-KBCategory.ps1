...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveCategory
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeCategory
   PS Module Safe Name: Invoke-KBRemoveCategory
   Function parsed from: CategoryProcedure.php
   Description parsed from: category_procedures.rst
#>
function Remove-KBCategory {
...
} # End Remove-KBCategory function
