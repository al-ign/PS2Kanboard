...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveSubtask
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeSubtask
   PS Module Safe Name: Invoke-KBRemoveSubtask
   Function parsed from: SubtaskProcedure.php
   Description parsed from: subtask_procedures.rst
#>
function Remove-KBSubtask {
