...
.DESCRIPTION
   ...
   Alias: Invoke-KBDisableProjectPublicAccess
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: disableProjectPublicAccess
   PS Module Safe Name: Invoke-KBDisableProjectPublicAccess
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Disable-KBProjectPublicAccess {
...
} # End Disable-KBProjectPublicAccess function
