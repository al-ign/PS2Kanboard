...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetLinkById
.OUTPUTS
   Returns link properties on success
   Returns false on failure
.NOTES
   API Function Name: getLinkById
   PS Module Safe Name: Invoke-KBGetLinkById
   Function parsed from: LinkProcedure.php
   Description parsed from: link_procedures.rst
#>
function Get-KBLinkById {
