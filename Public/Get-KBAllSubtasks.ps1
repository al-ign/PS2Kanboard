...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllSubtasks
.OUTPUTS
   Returns List of subtasks on success
   Returns false on failure
.NOTES
   API Function Name: getAllSubtasks
   PS Module Safe Name: Invoke-KBGetAllSubtasks
   Function parsed from: SubtaskProcedure.php
   Description parsed from: subtask_procedures.rst
#>
function Get-KBAllSubtasks {
...
} # End Get-KBAllSubtasks function
