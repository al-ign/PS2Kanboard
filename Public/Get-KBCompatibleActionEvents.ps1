<#
.Synopsis
   Get list of events compatible with an action
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetCompatibleActionEvents
.OUTPUTS
   Returns list of events on success
   Returns false on failure
.NOTES
   API Function Name: getCompatibleActionEvents
   PS Module Safe Name: Invoke-KBGetCompatibleActionEvents
   Function parsed from: ActionProcedure.php
   Description parsed from: action_procedures.rst
#>
function Get-KBCompatibleActionEvents {
...
} # End Get-KBCompatibleActionEvents function
