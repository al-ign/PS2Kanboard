<#
.Synopsis
   Get all metadata related to a task by task unique id
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetTaskMetadata
.OUTPUTS
   Returns list of metadata on success
   Returns empty array on failure
.NOTES
   API Function Name: getTaskMetadata
   PS Module Safe Name: Invoke-KBGetTaskMetadata
   Function parsed from: TaskMetadataProcedure.php
   Description parsed from: task_metadata_procedures.rst
#>
function Get-KBTaskMetadata {
...
} # End Get-KBTaskMetadata function
