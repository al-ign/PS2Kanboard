...
.DESCRIPTION
   ...
   Alias: Invoke-KBCloseTask, Set-KBTaskStatusClose
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: closeTask
   PS Module Safe Name: Invoke-KBCloseTask
   Function parsed from: TaskProcedure.php
   Description parsed from: task_procedures.rst
#>
function Close-KBTask {
