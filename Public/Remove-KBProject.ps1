...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveProject
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeProject
   PS Module Safe Name: Invoke-KBRemoveProject
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Remove-KBProject {
