...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetGroup
.OUTPUTS
   Returns Group dictionary on success
   Returns false on failure
.NOTES
   API Function Name: getGroup
   PS Module Safe Name: Invoke-KBGetGroup
   Function parsed from: GroupProcedure.php
   Description parsed from: group_procedures.rst
#>
function Get-KBGroup {
