...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetMemberGroups
.OUTPUTS
   Returns List of groups on success
   Returns false on failure
.NOTES
   API Function Name: getMemberGroups
   PS Module Safe Name: Invoke-KBGetMemberGroups
   Function parsed from: GroupMemberProcedure.php
   Description parsed from: group_member_procedures.rst
#>
function Get-KBMemberGroups {
...
} # End Get-KBMemberGroups function
