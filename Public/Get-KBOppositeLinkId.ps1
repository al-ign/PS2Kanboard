<#
.Synopsis
   Get the opposite link id of a task link
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetOppositeLinkId
.OUTPUTS
   Returns link_id on success
   Returns false on failure
.NOTES
   API Function Name: getOppositeLinkId
   PS Module Safe Name: Invoke-KBGetOppositeLinkId
   Function parsed from: LinkProcedure.php
   Description parsed from: link_procedures.rst
#>
function Get-KBOppositeLinkId {
...
} # End Get-KBOppositeLinkId function
