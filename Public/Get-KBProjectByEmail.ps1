...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectByEmail
.OUTPUTS
   Returns project properties on success
   Returns null on failure
.NOTES
   API Function Name: getProjectByEmail
   PS Module Safe Name: Invoke-KBGetProjectByEmail
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Get-KBProjectByEmail {
...
} # End Get-KBProjectByEmail function
