...
.DESCRIPTION
   ...
   Alias: Invoke-KBAddProjectUser
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: addProjectUser
   PS Module Safe Name: Invoke-KBAddProjectUser
   Function parsed from: ProjectPermissionProcedure.php
   Description parsed from: project_permission_procedures.rst
#>
function Add-KBProjectUser {
...
} # End Add-KBProjectUser function
