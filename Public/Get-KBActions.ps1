...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetActions
.OUTPUTS
   Returns list of actions properties on success
   Returns false on failure
.NOTES
   API Function Name: getActions
   PS Module Safe Name: Invoke-KBGetActions
   Function parsed from: ActionProcedure.php
   Description parsed from: action_procedures.rst
#>
function Get-KBActions {
