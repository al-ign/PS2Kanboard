...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetLinkByLabel
.OUTPUTS
   Returns link properties on success
   Returns false on failure
.NOTES
   API Function Name: getLinkByLabel
   PS Module Safe Name: Invoke-KBGetLinkByLabel
   Function parsed from: LinkProcedure.php
   Description parsed from: link_procedures.rst
#>
function Get-KBLinkByLabel {
...
} # End Get-KBLinkByLabel function
