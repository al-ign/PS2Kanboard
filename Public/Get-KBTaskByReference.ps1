...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetTaskByReference
.OUTPUTS
   Returns task properties on success
   Returns null on failure
.NOTES
   API Function Name: getTaskByReference
   PS Module Safe Name: Invoke-KBGetTaskByReference
   Function parsed from: TaskProcedure.php
   Description parsed from: task_procedures.rst
#>
function Get-KBTaskByReference {
...
Begin {
$ApiParameters = @('project_id', 'reference')
$hashApiParameters = @{}
...
$jsonParameters = @('project_id', 'reference')
$hashjsonParameters = @{}
...
} # End Get-KBTaskByReference function
