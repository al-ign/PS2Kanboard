...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetBoard
.OUTPUTS
   Returns board properties on success
   Returns empty list on failure
.NOTES
   API Function Name: getBoard
   PS Module Safe Name: Invoke-KBGetBoard
   Function parsed from: BoardProcedure.php
   Description parsed from: board_procedures.rst
#>
function Get-KBBoard {
