...
.DESCRIPTION
   ...
   Alias: Invoke-KBSetSubtaskEndTime
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: setSubtaskEndTime
   PS Module Safe Name: Invoke-KBSetSubtaskEndTime
   Function parsed from: SubtaskTimeTrackingProcedure.php
   Description parsed from: subtask_time_tracking_procedures.rst
#>
function Set-KBSubtaskEndTime {
...
} # End Set-KBSubtaskEndTime function
