...
.DESCRIPTION
   ...
   Alias: Invoke-KBUpdateSwimlane
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: updateSwimlane
   PS Module Safe Name: Invoke-KBUpdateSwimlane
   Function parsed from: SwimlaneProcedure.php
   Description parsed from: swimlane_procedures.rst
#>
function Set-KBSwimlane {
...
Begin {
$ApiParameters = @('project_id', 'swimlane_id', 'name', 'description')
$hashApiParameters = @{}
...
$jsonParameters = @('project_id', 'swimlane_id', 'name', 'description')
$hashjsonParameters = @{}
