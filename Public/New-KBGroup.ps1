...
.DESCRIPTION
   ...
   Alias: Invoke-KBCreateGroup
.OUTPUTS
   Returns link_id on success
   Returns false on failure
.NOTES
   API Function Name: createGroup
   PS Module Safe Name: Invoke-KBCreateGroup
   Function parsed from: GroupProcedure.php
   Description parsed from: group_procedures.rst
#>
function New-KBGroup {
...
Begin {
$ApiParameters = @('name', 'external_id')
$hashApiParameters = @{}
...
$jsonParameters = @('name', 'external_id')
$hashjsonParameters = @{}
