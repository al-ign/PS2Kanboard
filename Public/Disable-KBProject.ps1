...
.DESCRIPTION
   ...
   Alias: Invoke-KBDisableProject
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: disableProject
   PS Module Safe Name: Invoke-KBDisableProject
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Disable-KBProject {
...
} # End Disable-KBProject function
