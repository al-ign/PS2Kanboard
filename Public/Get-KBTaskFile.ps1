...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetTaskFile
.OUTPUTS
   Returns file properties on success
   Returns false on failure
.NOTES
   API Function Name: getTaskFile
   PS Module Safe Name: Invoke-KBGetTaskFile
   Function parsed from: TaskFileProcedure.php
   Description parsed from: task_file_procedures.rst
#>
function Get-KBTaskFile {
