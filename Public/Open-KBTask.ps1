...
.DESCRIPTION
   ...
   Alias: Invoke-KBOpenTask, Set-KBTaskStatusOpen
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: openTask
   PS Module Safe Name: Invoke-KBOpenTask
   Function parsed from: TaskProcedure.php
   Description parsed from: task_procedures.rst
#>
function Open-KBTask {
