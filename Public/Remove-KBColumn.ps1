...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveColumn
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeColumn
   PS Module Safe Name: Invoke-KBRemoveColumn
   Function parsed from: ColumnProcedure.php
   Description parsed from: column_procedures.rst
#>
function Remove-KBColumn {
