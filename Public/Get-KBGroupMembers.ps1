...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetGroupMembers
.OUTPUTS
   Returns List of users on success
   Returns false on failure
.NOTES
   API Function Name: getGroupMembers
   PS Module Safe Name: Invoke-KBGetGroupMembers
   Function parsed from: GroupMemberProcedure.php
   Description parsed from: group_member_procedures.rst
#>
function Get-KBGroupMembers {
...
} # End Get-KBGroupMembers function
