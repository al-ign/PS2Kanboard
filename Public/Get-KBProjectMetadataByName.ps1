...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectMetadataByName
.OUTPUTS
   Returns mixed on success
   Returns empty string on failure
.NOTES
   API Function Name: getProjectMetadataByName
   PS Module Safe Name: Invoke-KBGetProjectMetadataByName
   Function parsed from: ProjectMetaDataProcedure.php
   Description parsed from: project_metadata_procedures.rst
#>
function Get-KBProjectMetadataByName {
...
} # End Get-KBProjectMetadataByName function
