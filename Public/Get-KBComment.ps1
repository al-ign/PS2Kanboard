...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetComment
.OUTPUTS
   Returns comment properties on success
   Returns null on failure
.NOTES
   API Function Name: getComment
   PS Module Safe Name: Invoke-KBGetComment
   Function parsed from: CommentProcedure.php
   Description parsed from: comment_procedures.rst
#>
function Get-KBComment {
