<#
.Synopsis
   Get all files attached to task
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllTaskFiles
.OUTPUTS
   Returns list of files on success
   Returns false on failure
.NOTES
   API Function Name: getAllTaskFiles
   PS Module Safe Name: Invoke-KBGetAllTaskFiles
   Function parsed from: TaskFileProcedure.php
   Description parsed from: task_file_procedures.rst
#>
function Get-KBAllTaskFiles {
...
} # End Get-KBAllTaskFiles function
