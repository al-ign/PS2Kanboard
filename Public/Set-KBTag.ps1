...
.DESCRIPTION
   ...
   Alias: Invoke-KBUpdateTag
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: updateTag
   PS Module Safe Name: Invoke-KBUpdateTag
