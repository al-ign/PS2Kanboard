...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetTaskLinkById
.OUTPUTS
   Returns task link properties on success
   Returns false on failure
.NOTES
   API Function Name: getTaskLinkById
   PS Module Safe Name: Invoke-KBGetTaskLinkById
   Function parsed from: TaskLinkProcedure.php
   Description parsed from: internal_task_link_procedures.rst
#>
function Get-KBTaskLinkById {
...
} # End Get-KBTaskLinkById function
