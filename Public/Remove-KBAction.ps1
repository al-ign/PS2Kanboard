...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveAction
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeAction
   PS Module Safe Name: Invoke-KBRemoveAction
   Function parsed from: ActionProcedure.php
   Description parsed from: action_procedures.rst
#>
function Remove-KBAction {
