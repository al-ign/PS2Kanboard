...
.DESCRIPTION
   ...
   Alias: Invoke-KBAddGroupMember
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: addGroupMember
   PS Module Safe Name: Invoke-KBAddGroupMember
   Function parsed from: GroupMemberProcedure.php
   Description parsed from: group_member_procedures.rst
#>
function Add-KBGroupMember {
...
} # End Add-KBGroupMember function
