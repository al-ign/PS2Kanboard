...
.DESCRIPTION
   ...
   Alias: Invoke-KBMoveTaskToProject
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: moveTaskToProject
   PS Module Safe Name: Invoke-KBMoveTaskToProject
   Function parsed from: TaskProcedure.php
   Description parsed from: task_procedures.rst
#>
function Move-KBTaskToProject {
...
} # End Move-KBTaskToProject function
