...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveTag
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeTag
   PS Module Safe Name: Invoke-KBRemoveTag
   Function parsed from: TagProcedure.php
   Description parsed from: tags_procedures.rst
#>
function Remove-KBTag {
