...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveProjectUser
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeProjectUser
   PS Module Safe Name: Invoke-KBRemoveProjectUser
   Function parsed from: ProjectPermissionProcedure.php
   Description parsed from: project_permission_procedures.rst
#>
function Remove-KBProjectUser {
...
} # End Remove-KBProjectUser function
