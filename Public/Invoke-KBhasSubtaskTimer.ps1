...
.DESCRIPTION
   ...
   Alias: Invoke-KBHasSubtaskTimer
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: hasSubtaskTimer
   PS Module Safe Name: Invoke-KBHasSubtaskTimer
   Function parsed from: SubtaskTimeTrackingProcedure.php
   Description parsed from: subtask_time_tracking_procedures.rst
#>
function Invoke-KBhasSubtaskTimer {
...
} # End Invoke-KBhasSubtaskTimer function
