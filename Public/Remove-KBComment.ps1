...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveComment
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeComment
   PS Module Safe Name: Invoke-KBRemoveComment
   Function parsed from: CommentProcedure.php
   Description parsed from: comment_procedures.rst
#>
function Remove-KBComment {
