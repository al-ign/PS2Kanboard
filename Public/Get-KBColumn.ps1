...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetColumn
.OUTPUTS
   Returns column properties on success
   Returns null on failure
.NOTES
   API Function Name: getColumn
   PS Module Safe Name: Invoke-KBGetColumn
   Function parsed from: ColumnProcedure.php
   Description parsed from: column_procedures.rst
#>
function Get-KBColumn {
