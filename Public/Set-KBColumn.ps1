...
.DESCRIPTION
   ...
   Alias: Invoke-KBUpdateColumn
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: updateColumn
   PS Module Safe Name: Invoke-KBUpdateColumn
   Function parsed from: ColumnProcedure.php
   Description parsed from: column_procedures.rst
#>
function Set-KBColumn {
...
Begin {
$ApiParameters = @('column_id', 'title', 'task_limit', 'description')
$hashApiParameters = @{}
...
$jsonParameters = @('column_id', 'title', 'task_limit', 'description')
$hashjsonParameters = @{}
