...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectActivities
.OUTPUTS
   Returns List of events on success
   Returns false on failure
.NOTES
   API Function Name: getProjectActivities
   PS Module Safe Name: Invoke-KBGetProjectActivities
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Get-KBProjectActivities {
...
} # End Get-KBProjectActivities function
