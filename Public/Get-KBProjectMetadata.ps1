...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectMetadata
.OUTPUTS
   Returns dictionary of metadata on success
   Returns false on failure
.NOTES
   API Function Name: getProjectMetadata
   PS Module Safe Name: Invoke-KBGetProjectMetadata
   Function parsed from: ProjectMetaDataProcedure.php
   Description parsed from: project_metadata_procedures.rst
#>
function Get-KBProjectMetadata {
...
} # End Get-KBProjectMetadata function
