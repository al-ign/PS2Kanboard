<#
.Synopsis
   Remove a file associated to a project
...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveProjectFile
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeProjectFile
   PS Module Safe Name: Invoke-KBRemoveProjectFile
   Function parsed from: ProjectFileProcedure.php
   Description parsed from: project_file_procedures.rst
#>
function Remove-KBProjectFile {
...
} # End Remove-KBProjectFile function
