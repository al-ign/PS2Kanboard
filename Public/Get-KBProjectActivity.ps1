...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectActivity
.OUTPUTS
   Returns List of events on success
   Returns false on failure
.NOTES
   API Function Name: getProjectActivity
   PS Module Safe Name: Invoke-KBGetProjectActivity
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Get-KBProjectActivity {
...
} # End Get-KBProjectActivity function
