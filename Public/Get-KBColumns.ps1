<#
.Synopsis
   Get all columns information for a given project
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetColumns
.OUTPUTS
   Returns columns properties on success
   Returns empty list on failure
.NOTES
   API Function Name: getColumns
   PS Module Safe Name: Invoke-KBGetColumns
   Function parsed from: ColumnProcedure.php
   Description parsed from: column_procedures.rst
#>
function Get-KBColumns {
