<#
.Synopsis
   Remove all files associated to a task
...
.DESCRIPTION
   ...
   Alias: Invoke-KBRemoveAllTaskFiles
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: removeAllTaskFiles
   PS Module Safe Name: Invoke-KBRemoveAllTaskFiles
   Function parsed from: TaskFileProcedure.php
   Description parsed from: task_file_procedures.rst
#>
function Remove-KBAllTaskFiles {
...
} # End Remove-KBAllTaskFiles function
