...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectById
.OUTPUTS
   Returns project properties on success
   Returns null on failure
.NOTES
   API Function Name: getProjectById
   PS Module Safe Name: Invoke-KBGetProjectById
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Get-KBProjectById {
...
} # End Get-KBProjectById function
