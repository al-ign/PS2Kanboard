...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetTagsByProject
.OUTPUTS
   Returns List of tags on success
   Returns false|null on failure
.NOTES
   API Function Name: getTagsByProject
   PS Module Safe Name: Invoke-KBGetTagsByProject
   Function parsed from: TagProcedure.php
   Description parsed from: tags_procedures.rst
#>
function Get-KBTagsByProject {
...
} # End Get-KBTagsByProject function
