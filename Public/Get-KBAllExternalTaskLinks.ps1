<#
.Synopsis
   Get all external links attached to a task
...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllExternalTaskLinks
.OUTPUTS
   Returns list of external links on success
   Returns false on failure
.NOTES
   API Function Name: getAllExternalTaskLinks
   PS Module Safe Name: Invoke-KBGetAllExternalTaskLinks
   Function parsed from: TaskExternalLinkProcedure.php
   Description parsed from: external_task_link_procedures.rst
#>
function Get-KBAllExternalTaskLinks {
...
} # End Get-KBAllExternalTaskLinks function
