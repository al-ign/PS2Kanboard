...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetAllProjectFiles
.OUTPUTS
   Returns list of files on success
   Returns false on failure
.NOTES
   API Function Name: getAllProjectFiles
   PS Module Safe Name: Invoke-KBGetAllProjectFiles
   Function parsed from: ProjectFileProcedure.php
   Description parsed from: project_file_procedures.rst
#>
function Get-KBAllProjectFiles {
...
} # End Get-KBAllProjectFiles function
