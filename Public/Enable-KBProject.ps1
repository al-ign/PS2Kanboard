...
.DESCRIPTION
   ...
   Alias: Invoke-KBEnableProject
.OUTPUTS
   Returns true on success
   Returns false on failure
.NOTES
   API Function Name: enableProject
   PS Module Safe Name: Invoke-KBEnableProject
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Enable-KBProject {
