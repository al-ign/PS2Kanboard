...
.DESCRIPTION
   ...
   Alias: Invoke-KBCreateTag
.OUTPUTS
   Returns tag_id on success
   Returns false on failure
.NOTES
   API Function Name: createTag
   PS Module Safe Name: Invoke-KBCreateTag
