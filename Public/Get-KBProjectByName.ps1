...
.DESCRIPTION
   ...
   Alias: Invoke-KBGetProjectByName
.OUTPUTS
   Returns project properties on success
   Returns null on failure
.NOTES
   API Function Name: getProjectByName
   PS Module Safe Name: Invoke-KBGetProjectByName
   Function parsed from: ProjectProcedure.php
   Description parsed from: project_procedures.rst
#>
function Get-KBProjectByName {
...
} # End Get-KBProjectByName function
